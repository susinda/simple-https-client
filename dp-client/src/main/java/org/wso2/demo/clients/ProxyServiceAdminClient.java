...
public class ProxyServiceAdminClient {
    ...
    public void addProxyService(String proxyName, String wsdlURI,
            ...
            throws ProxyServiceAdminProxyAdminException, RemoteException, org.wso2.carbon.proxyadmin.stub.Exception {
    ...
    public void addProxyService(DataHandler dh)
            throws ProxyServiceAdminProxyAdminException, IOException, XMLStreamException, org.wso2.carbon.proxyadmin.stub.Exception {
    ...
    public void addProxyService(String data)
            throws ProxyServiceAdminProxyAdminException, IOException, XMLStreamException, org.wso2.carbon.proxyadmin.stub.Exception {

        ProxyData proxyData = getProxyData(data);
        proxyServiceAdminStub.addProxy(proxyData);
        log.info("Proxy Added");
    }
